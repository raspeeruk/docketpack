...
export const metadata: Metadata = {
  title: "Retail Shop Compliance Documents — Federal & State Requirements",
  description:
    "Every compliance document your retail store needs. OSHA safety, ADA accessibility, PCI compliance, loss prevention, return policies, and state-specific consumer protection.",
};

const STATES_WITH_DOCS = ["california", "texas", "florida", "new-york"];

export default function USRetailPage() {
  const federalDocs = getUSFederalDocuments("retail");
    ...
    <>
      <section className="bg-cotton py-16 md:py-20">
        <div className="mx-auto max-w-[1120px] px-6 md:px-12">
          <h1 className="font-heading text-4xl text-walnut md:text-5xl lg:text-6xl">
            Retail Shop Documents
          </h1>
          <p className="mt-4 max-w-2xl font-body text-base font-light text-graphite leading-relaxed">
            OSHA safety, ADA accessibility, PCI card processing compliance, loss
            prevention policies, return and refund procedures, and state consumer
            protection — every document generated for your store, referencing the
            exact laws that apply to you.
          </p>
          <div className="mt-8 flex flex-wrap gap-4">
            <RubberStampCTA href="/generate/?industry=retail" size="large">
      ...
      <section className="border-t-2 border-walnut bg-cotton py-12 md:py-16">
        <div className="mx-auto max-w-[1120px] px-6 md:px-12">
          ...
          <p className="mt-3 max-w-2xl font-body text-sm font-light text-graphite">
            These documents are required by federal law for every retail store in
            the United States, regardless of state.
          </p>
          <div className="mt-8 grid grid-cols-1 gap-3 md:grid-cols-2">
            {federalDocs.map((doc) => (
              <Link
                key={doc.slug}
                href={`/retail/${doc.slug}/`}
      ...
      <section className="border-t-2 border-dashed border-fold bg-manila/50 py-16 md:py-20">
        <div className="mx-auto max-w-[1120px] px-6 md:px-12">
          ...
          <p className="mt-3 max-w-2xl font-body text-sm font-light text-graphite">
            Each state has its own sales tax requirements, consumer protection
            laws, and labor regulations. Select your state for documents tailored
            ...
            {activeStates.map((state) => (
              ...
              >
                ...
                <p className="mt-2 font-mono text-xs text-burgundy">
                  Consumer protection + state docs
                </p>
