...
export const metadata: Metadata = {
  title: "Tattoo & Piercing Studio Compliance Documents — Federal & State Requirements",
  description:
    "Every compliance document your tattoo or piercing studio needs. Bloodborne pathogen plans, sterilization protocols, consent forms, body art licensing, and state-specific requirements.",
};

const STATES_WITH_DOCS = ["california", "texas", "florida", "new-york"];

export default function USTattooPage() {
  const federalDocs = getUSFederalDocuments("tattoo");
    ...
    <>
      <section className="bg-cotton py-16 md:py-20">
        <div className="mx-auto max-w-[1120px] px-6 md:px-12">
          <h1 className="font-heading text-4xl text-walnut md:text-5xl lg:text-6xl">
            Tattoo & Piercing Documents
          </h1>
          <p className="mt-4 max-w-2xl font-body text-base font-light text-graphite leading-relaxed">
            OSHA bloodborne pathogen plans, autoclave sterilization protocols,
            client consent forms, biohazardous waste disposal, body art licensing,
            and state health department requirements — every document generated
            for your studio, referencing the exact laws that apply to you.
          </p>
          <div className="mt-8 flex flex-wrap gap-4">
            <RubberStampCTA href="/generate/?industry=tattoo" size="large">
      ...
      <section className="border-t-2 border-walnut bg-cotton py-12 md:py-16">
        <div className="mx-auto max-w-[1120px] px-6 md:px-12">
          ...
          <p className="mt-3 max-w-2xl font-body text-sm font-light text-graphite">
            These documents are required by federal law for every tattoo and
            piercing studio in the United States, regardless of state.
          </p>
          <div className="mt-8 grid grid-cols-1 gap-3 md:grid-cols-2">
            {federalDocs.map((doc) => (
              <Link
                key={doc.slug}
                href={`/tattoo/${doc.slug}/`}
      ...
      <section className="border-t-2 border-dashed border-fold bg-manila/50 py-16 md:py-20">
        <div className="mx-auto max-w-[1120px] px-6 md:px-12">
          ...
          <p className="mt-3 max-w-2xl font-body text-sm font-light text-graphite">
            Each state has its own body art licensing, sterilization standards,
            and age restriction laws. Select your state for documents tailored to
