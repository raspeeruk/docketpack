...
export const metadata: Metadata = {
  title: "Gym & Fitness Studio Compliance Documents — Federal & State Requirements",
  description:
    "Every compliance document your gym or fitness studio needs. OSHA safety, AED requirements, membership agreements, liability waivers, and state-specific health club laws.",
};

const STATES_WITH_DOCS = ["california", "texas", "florida", "new-york"];

export default function USGymPage() {
  const federalDocs = getUSFederalDocuments("gym");
    ...
    <>
      <section className="bg-cotton py-16 md:py-20">
        <div className="mx-auto max-w-[1120px] px-6 md:px-12">
          <h1 className="font-heading text-4xl text-walnut md:text-5xl lg:text-6xl">
            Gym & Fitness Studio Documents
          </h1>
          <p className="mt-4 max-w-2xl font-body text-base font-light text-graphite leading-relaxed">
            OSHA safety plans, AED emergency protocols, membership agreements,
            liability waivers, contractor classification, and state health club
            laws — every document generated for your gym, referencing the exact
            laws that apply to you.
          </p>
          <div className="mt-8 flex flex-wrap gap-4">
            <RubberStampCTA href="/generate/?industry=gym" size="large">
      ...
      <section className="border-t-2 border-walnut bg-cotton py-12 md:py-16">
        <div className="mx-auto max-w-[1120px] px-6 md:px-12">
          ...
          <p className="mt-3 max-w-2xl font-body text-sm font-light text-graphite">
            These documents are required by federal law for every gym and fitness
            studio in the United States, regardless of state.
          </p>
      ...
      <section className="border-t-2 border-dashed border-fold bg-manila/50 py-16 md:py-20">
        <div className="mx-auto max-w-[1120px] px-6 md:px-12">
          ...
          <p className="mt-3 max-w-2xl font-body text-sm font-light text-graphite">
            Each state has its own health club laws, membership contract
            requirements, and safety standards. Select your state for documents
